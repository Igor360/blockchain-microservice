...
class Web3Service {
    ...
    constructor() {
        ...
        engine.addProvider(new InfuraSubProvider({rpcUrl: infuraConfigs.addressInfura}));
    ...
    #convertGasPrice(price) {
        return new BigNumber(price).multipliedBy(new BigNumber(Math.pow(10, 9))).toNumber();
    }
